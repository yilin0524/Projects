...
public class Packet {
	...
	public static final int SYN_ACK_ACK = 2;
	public static final int DATA = 3;
	public static final int ACK = 4;
	public static final int FIN = 5;
	public static final int FIN_ACK = 6;
	public static final int FIN_ACK_ACK = 7;
    ...
    public static final String routerHost = "127.0.0.1";//"127.0.0.1";
    public static final int routerPort = 3000;
    
    public static final SocketAddress routerAddress = new InetSocketAddress(Packet.routerHost, Packet.routerPort);
