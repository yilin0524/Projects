...
*/	        		 		
	        		 if(DEMSInterface.addEvent(eventID, eventType, managerID,  cap)) {	
	        	 ...
	        	 case 2:	//2: remove Event
	        		 ...
	        		 if(DEMSInterface.removeEvent(eID,eT, managerID)){
	        	 ...
	        	 case 3:	//3: list Event Availability
	        		 ...
	        		 String result=DEMSInterface.listEventA(managerID, curType);
	        	 ...
	        	 case 4:	//4: book Event
	        		 ...
	        		 System.out.println("The customer : "+cID+" The event is : "+ evenID+" the type is : "+ type);
		        		 if(DEMSInterface.bookEvent(cID,evenID, type)){
	        	 ...
	        	 case 5:	//5: get booking Schedule
	        		 ...
	        		 if(isCustomer(cusID5)&&(cus5City.equals(city))) {		//Same city
		        		 String result5=DEMSInterface.getBookingSchedule(cusID5);
	        	 ...
	        	 case 6:	//6: cancel Event
	        		 ...
	        		 if(isCustomer(cusID6)&& cus6City.equals(city)) { 		//Same city
		        		 if(DEMSInterface.cancelEvent(cusID6, eID6, type6)){
	 			...
	 			case 7:
					...
					if (isCustomer(cusID7) && cus7City.equals(city)) { // Same city
						if (DEMSInterface.swapEvent(cusID7, newID7, newType7, oldID7, oldType7)) {
